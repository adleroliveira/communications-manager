...
import { IRequest, IResponse, IResponseData } from './interfaces.js';
...
export class RequestManager extends EventEmitter {
    ...
    private pendingRequests: Map<string, (response: IResponse<any>) => void> = new Map();
    ...
    private createRequest<T>(requestType: string, body: T, to?: string): IRequest<T> {
        return {
            header: {
                timestamp: Date.now(),
                requestId: `RM-${uuidv4()}`,
