...
var AuthenticationManager = /** @class */ (function () {
    function AuthenticationManager(requestManager, websocketsServername) {
        if (websocketsServername === void 0) { websocketsServername = "websockets"; }
        this.requestManager = requestManager;
        this.websocketsServername = websocketsServername;
        this.authToken = null;
    }
    AuthenticationManager.prototype.setAuthToken = function (token) {
        this.authToken = token;
    };
    AuthenticationManager.prototype.clearAuthToken = function () {
        this.authToken = null;
    };
    ...
    AuthenticationManager.prototype.getAuthToken = function () {
